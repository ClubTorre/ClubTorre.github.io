<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>Club Torre | Muy Pronto<?php echo "!"?></title>
            <link rel="stylesheet" media="(min-width: 601px)" href="desktop.css">
            <link rel="stylesheet" media="(max-width: 600px)" href="mobile.css">
            <link rel="icon" href="./clubTorre.png">
        </head>
        <body class = "flex">
            <a href = "https://www.facebook.com/profile.php?id=100089183790711&sk=followers" target="_blank" rel="noopener noreferrer"class = "flex">
